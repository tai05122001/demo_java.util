...
@RestController
@RequestMapping(path = "demo/copylist")
public class CopyOnWriteArrayListController {
    ...
    private void addAllList(){
        List<Integer> listsub = new CopyOnWriteArrayList<>(Arrays.asList(1,2,3,7,8));
    ...
    private void setContentWeb(){
        ...
        setContent(content.concat(
                ...
                "<h1 style='color:red;text-align:center'>Demo cho thư viện CopyOnWriteArrayList </h1>"+
        ...
        setContent(content.concat(
                "</br></br>" +
                        "Xóa một phần tử ở vị trí số <strong> 4 </strong> trong list </br>"
        ));
        ...
        setContent(content.concat(
                "</br></br>" +
                        "Xóa một phần tử có giá trị bằng <strong> 12 </strong> trong list </br>"
        ));
        removeObject(5);
        printList();
