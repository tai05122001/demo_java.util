...
@RestController
@RequestMapping(path = "demo/vector")
public class VectorController{
    ...
    private void addAllList(){
        List<Integer> listsub = new Vector<>(Arrays.asList(5,6,7,8));
    ...
    private void setContentWeb(){
        ...
        setContent(content.concat(
                ...
                "<h1 style='color:red;text-align:center'>Demo cho thư viện Vector </h1>"+
