...
@RestController
@RequestMapping(path = "demo/weakhashmap")
public class WeakHashMapController {
...
//        addMap();
    ...
    private void addAllMap(){
        map = new HashMap<>();
        HashMap mapSub =  new HashMap<String, Integer>() {{
            put("Alice", 25);
            put("Bob", 30);
            put("Charlie", 35);
            put("Adam", 31);
    ...
    private void setContentWeb(){
        ...
        setContent(content.concat(
                ...
                "<h1 style='color:red;text-align:center'>Demo cho thư viện WeakHashMap </h1>"+
