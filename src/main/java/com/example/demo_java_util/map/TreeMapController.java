...
@RestController
@RequestMapping(path = "demo/treemap")
public class TreeMapController {
    ...
    @GetMapping
    private String demoWeakHashMap(){
        initMap();
        showMap();
        return view;
...
//        addMap();
    ...
    private void addAllMap(){
        map = new TreeMap<>();
        TreeMap mapSub =  new TreeMap<String, Integer>() {{
            put("Alice", 25);
            put("Bob", 30);
            put("Charlie", 35);
            put("Adam", 31);
    ...
    private void setContentWeb(){
        ...
        setContent(content.concat(
                ...
                "<h1 style='color:red;text-align:center'>Demo cho thư viện TreeMap </h1>"+
