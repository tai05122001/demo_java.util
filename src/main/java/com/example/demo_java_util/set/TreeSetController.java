...
@RestController
@RequestMapping(path = "demo/treeset")
public class TreeSetController {
    ...
    private void addAllList(){
        Set<Integer> listsub = new TreeSet<>(){{
            add(1);
            add(3);
            add(2);
            add(10);
    ...
    private void setContentWeb(){
        ...
        setContent(content.concat(
                ...
                "<h1 style='color:red;text-align:center'>Demo cho thư viện TreeSet</h1>"+
